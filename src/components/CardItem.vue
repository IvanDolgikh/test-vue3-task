<template>
    <div class="card" :style="`box-shadow: 0px 0px 27px 0px ${borderColor}`">
        ...
        <v-tooltip text="Переместить товар">
            <template v-slot:activator="{ props }">
                <v-btn v-bind="props" icon="mdi-arrow-right" density="compact" variant="tonal" class="to-right-btn"
                    color="grey" @click="toNextList" />
            </template>
        </v-tooltip>
        <v-tooltip text="Переместить товар">
            <template v-slot:activator="{ props }">
                <v-btn v-bind="props" icon="mdi-arrow-left" density="compact" variant="tonal" class="to-left-btn"
                    color="grey" @click="toPreviousList" />
            </template>
        </v-tooltip>
        ...
        <CardForm title="Редактирование карточки" v-model="isEditCardDialogOpen" :form="props.card"
            @save-card="saveCard" @close-form="isEditCardDialogOpen = false" />
